...
const Perfil = () => {
    ...
    const calculateItemsToShow = () => {
        ...
        else if (window.innerWidth <= 1360) { return 4; }
        else if (window.innerWidth <= 1560) { return 5; }
        else if (window.innerWidth <= 1760) { return 6; }
        else if (window.innerWidth <= 1960) { return 7; }
        else {return 7;}
    };
    ...
    const handleNext = () => {
        if (startIndex + itemsToShow < produtos.length) {
    ...
    const isAtEnd = startIndex + itemsToShow >= produtos.length;
                ...
                <section className="UltimosProdutos">
                    ...
                    <div className="CarrosselProdutos">
                        ...
                        <div className="ConjAnuncioPerfil">
                                {produtos.slice(startIndex, startIndex + itemsToShow).map((produto, index) => (
